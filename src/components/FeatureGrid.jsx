  ...
  const features = [
    {
      ...
      gradient: 'from-[#00FF75]/20 to-emerald-950/40',
      borderColor: 'border-[#00FF75]/30',
      iconColor: 'text-[#00FF75]',
    ...
    },
    {
      ...
      gradient: 'from-amber-500/20 to-slate-900/40',
    ...
    <section id="features" className="py-24 relative overflow-hidden bg-[#0A0E17]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-[#00FF75]">
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <div
                ...
                className={`group relative glass-card rounded-3xl p-8 cursor-pointer transition-all duration-300 flex flex-col justify-between ${
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className={`w-14 h-14 rounded-2xl bg-slate-900/90 border ${feature.borderColor} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
                      <Icon className={`w-7 h-7 ${feature.iconColor}`} />
                    </div>
                    <span className={`text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full bg-white/5 border ${feature.borderColor} text-slate-200`}>
                      {feature.badge}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold font-heading text-white group-hover:text-[#00FF75] transition-colors">
                      {feature.title}
                    </h3>
                ...
                <div className="relative z-10 pt-6 flex items-center gap-2 text-xs font-bold text-slate-300 group-hover:text-white transition-colors">
                  <span>Explore Feature</span>
                  <ArrowRight className="w-4 h-4 text-[#00FF75] group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
            );
          })}
